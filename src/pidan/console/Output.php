...
namespace pidan\console;

use Exception;
use pidan\console\output\Ask;
use pidan\console\output\Descriptor;
use pidan\console\output\driver\Buffer;
use pidan\console\output\driver\Console;
use pidan\console\output\driver\Nothing;
use pidan\console\output\Question;
use pidan\console\output\question\Choice;
use pidan\console\output\question\Confirmation;
use Throwable;

/**
 * Class Output
 * @package pidan\console
 *
 * @see     \pidan\console\output\driver\Console::setDecorated
 * @method void setDecorated($decorated)
 *
 * @see     \pidan\console\output\driver\Buffer::fetch
 * @method string fetch()
 *
...
class Output
{
    ...
    {
        $class = '\\pidan\\console\\output\\driver\\' . ucwords($driver);
