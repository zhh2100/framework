 ...
 * @mixin \pidan\Request
 * @method static \pidan\Request setDomain(string $domain) 设置当前包含协议的域名
 * @method static string domain(bool $port = false) 获取当前包含协议的域名
 * @method static string rootDomain() 获取当前根域名
 * @method static \pidan\Request setSubDomain(string $domain) 设置当前泛域名的值
 * @method static string subDomain() 获取当前子域名
 * @method static \pidan\Request setPanDomain(string $domain) 设置当前泛域名的值
 * @method static string panDomain() 获取当前泛域名的值
 * @method static \pidan\Request setUrl(string $url) 设置当前完整URL 包括QUERY_STRING
 * @method static string url(bool $complete = false) 获取当前完整URL 包括QUERY_STRING
 * @method static \pidan\Request setBaseUrl(string $url) 设置当前URL 不含QUERY_STRING
 ...
 * @method static \pidan\Request setRoot(string $url) 设置URL访问根地址
 * @method static string root(bool $complete = false) 获取URL访问根地址
 * @method static string rootUrl() 获取URL访问根目录
 * @method static \pidan\Request setPathinfo(string $pathinfo) 设置当前请求的pathinfo
 ...
 * @method static \pidan\Request setMethod(string $method) 设置请求类型
 ...
 * @method static \pidan\Request setRule(Rule $rule) 设置路由变量
 * @method static Rule|null rule() 获取当前路由对象
 * @method static \pidan\Request setRoute(array $route) 设置路由变量
 ...
 * @method static \pidan\Request setHost(string $host) 设置当前请求的host（包含端口）
 ...
 * @method static \pidan\Request setController(string $controller) 设置当前的控制器名
 * @method static \pidan\Request setAction(string $action) 设置当前的操作名
 ...
 * @method static \pidan\Request withMiddleware(array $middleware) 设置在中间件传递的数据
 * @method static \pidan\Request withGet(array $get) 设置GET数据
 * @method static \pidan\Request withPost(array $post) 设置POST数据
 * @method static \pidan\Request withCookie(array $cookie) 设置COOKIE数据
 * @method static \pidan\Request withSession(Session $session) 设置SESSION数据
 * @method static \pidan\Request withServer(array $server) 设置SERVER数据
 * @method static \pidan\Request withHeader(array $header) 设置HEADER数据
 * @method static \pidan\Request withEnv(Env $env) 设置ENV数据
 * @method static \pidan\Request withInput(string $input) 设置php://input数据
 * @method static \pidan\Request withFiles(array $files) 设置文件上传数据
 * @method static \pidan\Request withRoute(array $route) 设置ROUTE变量
