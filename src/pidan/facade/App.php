 ...
 * @mixin \pidan\App
 * @method static \pidan\Service|null register(\pidan\Service|string $service, bool $force = false) 注册服务
 * @method static mixed bootService(\pidan\Service $service) 执行服务
 * @method static \pidan\Service|null getService(string|\pidan\Service $service) 获取服务
 * @method static \pidan\App debug(bool $debug = true) 开启应用调试模式
 * @method static bool isDebug() 是否为调试模式
 * @method static \pidan\App setNamespace(string $namespace) 设置应用命名空间
 ...
 * @method static string getPidanPath() 获取核心框架目录
 ...
 * @method static \pidan\App initialize() 初始化应用
